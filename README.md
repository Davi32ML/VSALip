...
- [How to prepare the dataset](#How-to-install-the-environment)
...
We provide the [identity features](data/lipauth_support) of ICSLR test data after registration, which can be directly used for evaluation. 
